 ...
 */
public class ScriptTriggerAction implements Action {
    ...
    public void writeLogTo(XMLOutput out) throws IOException {
        new AnnotatedLargeText<ScriptTriggerAction>(getLogFile(), Charset.defaultCharset(), true, this).writeHtmlTo(0, out.asWriter());
    }
